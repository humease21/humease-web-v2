...
H1: **기업 데이터와 아이디어를 실제 동작하는 서비스로**

본문: “기업 데이터의 보존과 통제부터 AI 서비스의 설계와 구현까지 휴미즈는 현실의 문제를 해결로 연결합니다.”(2줄)
...
전: **흩어진 데이터** / “흩어진 데이터와 관리 기준, AI 여정에 복잡한 IT 환경”
후: **이해할 수 있는 정보로** / “데이터 거버넌스를 통해 AX 전환을 도와드립니다”(2줄)

이미지 A03. JS·모션이 없으면 두 메시지가 동시에 정적으로 읽혀야 한다.

### 3. 왜 휴미즈인가

H2: **데이터를 이해하고, AX 전환 설계**

본문: “20년 이상의 Enterprise IT 경험으로, 데이터 거버넌스부터 AI 활용까지 기업의 AX 전환 지원합니다.”(1줄 고정, measure 제거)

[내부] '휴미즈 법인이 20년간 운영됐다'고 읽히는 표현은 금지한다.

### 4. 기업 데이터 (01)

H2: **중요한 데이터는 / 보관보다 관리가 중요합니다**(2줄)

본문: “무엇을 얼마나 보존하고, 누가 접근하며, 필요할 때 어떻게 활용할지 데이터의 전체 흐름을 고객 환경과 운영 기준에 맞춰 설계합니다.”(2줄)
...
H2: **우리가 만든 서비스가, 새로운 일상을 만듭니다**

본문: “아이디어를 실제 서비스로 구현해 온 과정, 휴미즈의 AI 프로젝트가 해결한 문제를 소개합니다.”
...
대형 문구: **20년 이상의 IT 전문 경험, 기업의 AX 전환을 성과로 연결합니다.**

H2: **수많은 문제를 해결해 온 경험에서 기술의 깊이가 나옵니다.**
본문: “기업의 복잡한 IT 환경을 이해하고, 실행 가능한 구조로 설계합니다.”
...
H2: **해결하고 싶은 문제가 있다면, / 언제든지 연락주세요**(2줄)
본문: “기업 환경의 IT 고민부터 AX 전환에 따른 아이디어까지, 현재 상황과 기대하는 변화를 알려주세요.”
