 ...
 *
 * representative 는 개인정보처리방침 V1.0(제11조, 2026-09-18 승인)에서 확인됐다.
 * businessNumber·address·대표전화는 여전히 승인본이 없어 비워 둔다 — 추정해 채우지 않는다.
 */
export const company = {
  ...
  representative: '정미경 대표이사' as string | null,
